$(document).ready(function myfunction() {
    ...
    $('#list').jqGrid({
        ...
        mtype: 'GET',
        sortname: "Role",
        colNames: ['Id', 'Name', 'Mobile'],
        colModel: [
              { name: 'Id', index: 'Id', key: true, hidden: true },
              { name: 'User', index: 'Name', width: 80, key: false, editable: true, edittype: "select", editrules: { required: true } },
              { name: 'Role', index: 'Mobile', width: 80, key: false, editable: true, edittype: "select", editrules: { required: true } }
        ],
        rowNum: 10,
        rowList: [10, 20, 30],
        viewrecords: true,
